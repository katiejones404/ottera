...
export default function App() {
  ...
  const cycleDemoSignIn = () => {
    ...
    const currentIndex = MOCK_ACCOUNTS.findIndex((account) => account.id === sessionId);
  ...
  return (
    <div className="app-shell">
      ...
      <main>
        {session ? (
          <PortalShell session={session} onReturnToLanding={() => setSessionId(null)} />
        ) : (
          <PublicLanding activePage={activePage} onEnterPortal={cycleDemoSignIn} />
        )}
      </main>
